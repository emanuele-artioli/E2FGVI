...
def main_worker(args):
    ...
    net = importlib.import_module(f'e2fgvi.model.{args.model}')
    ...
    result_path = result_root / f'{args.model}_{args.dataset}'
    result_path.mkdir(parents=True, exist_ok=True)
    eval_summary = (result_path / f"{args.model}_{args.dataset}_metrics.txt").open("w", encoding='utf-8')
